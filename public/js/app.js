...
window.vue = new Vue({
  ...
  methods: (_methods = {
  ...
  }), _defineProperty(_methods, "renderItem", function renderItem(elem) {
    var tags = '';
    ...
    if (renderItemInfo) {
      itemInfo = '<div class="review-iteminfo"><a href="' + window.location.origin + '/view/' + elem.item.slug + '">' + elem.item.name + '</a></div>';
    }
  ...
  }), _defineProperty(_methods, "reportItem", function reportItem(id) {
    window.vue.ajaxRequest('get', window.location.origin + '/item/' + id + '/report', {}, function (response) {
      alert(response.msg);
    });
  }), _defineProperty(_methods, "deleteItem", function deleteItem(id) {
    if (!confirm(window.vue.translationTable.confirmDeleteItem)) {
      return;
    }

    window.vue.ajaxRequest('get', window.location.origin + '/item/' + id + '/delete', {}, function (response) {
      alert(response.msg);
    });
