    ...
    <div class="container">
        <div class="columns">
            ...
            <div class="column is-10">
                ...
                <div class="profile-resource-items-hint">{{ __('app.items_by_user') }}</div>
...
@section('javascript')
    <script>
        ...
        window.queryUserItems = function() {
            ...
            window.vue.ajaxRequest('post', '{{ url('/item/query/user') }}', {
                user: window.user,
            ...
            function(response) {
                if (response.code == 200) {
                    ...
                    if (response.data.length === 0) {
                        ...
                        content.innerHTML += '<div id="loadmore"><center><br/><i class="fas fa-plus is-pointer" onclick="window.queryUserItems();"></i></center></div>';
                    }
                } else {
